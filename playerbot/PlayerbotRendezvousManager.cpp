...
bool PlayerbotRendezvousManager::BeginPartyFreeTime(Player* bot, Player* player, const std::string& reason)
{
    ...
    if(fixture && environment && (std::string(fixture)=="activity-party-auction-checkpoint-v1" ||
        std::string(fixture)=="activity-party-auction-intent-resume-v1" ||
    ...
    if(fixture && environment && (std::string(fixture)=="activity-party-profession-checkpoint-v1" ||
        ...
        std::string(fixture)=="activity-party-profession-recall-v1" ||
