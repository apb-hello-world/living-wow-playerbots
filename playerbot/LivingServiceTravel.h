...
namespace LivingActivity {
    ...
    enum class ServiceDestination { Mailbox, PersonalBank, CraftingStation, Vendor, PurchaseVendor, AuctionHouse, GuildBank, GuildMailbox, Gathering, Repair };
